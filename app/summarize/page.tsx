    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-white border-b shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-4 sm-py-6">
          <div className="flex justify-center items-center gap-3 mb-2">
            ...
            <Link href={'/'} className="text-xl sm:text-2xl font-bold">quick summarizer</Link>
          </div>
      ...
      <motion.main
        ...
        <Card className="flex flex-col shadow-sm h-[50vh] sm:h-[70vh]">
          ...
          <CardContent className="flex-1 w-full overflow-auto space-y-4">
            ...
            <Textarea
              ...
              className="h-[24vh] [&::-webkit-scrollbar]:hidden sm:h-full sm:max-h-[48vh] resize-none overflow-auto"
            />
          </CardContent>
          <CardFooter>
            <Button
        ...
        <Card className="flex flex-col shadow-sm h-fit md:h-[70vh]">
          ...
          <CardContent className="flex-1 w-full overflow-auto space-y-4 [&::-webkit-scrollbar]:hidden">
            {sections.length > 0 ? (
              sections.map((sec, i) => (
                <div
                  key={i}
